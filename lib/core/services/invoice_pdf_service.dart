...
class InvoicePdfService {
  ...
  Future<Uint8List> build(
    ...
    final date = '${invoice.date.day.toString().padLeft(2, '0')}/'
    ...
    document.addPage(
      pw.MultiPage(
        ...
        footer: (context) => pw.Container(
          ...
          child: pw.Text(
            'Généré par ComptaFlow • ${invoice.invoiceNumber}',
        ...
        build: (context) => [
                ...
                children: [
                  ...
                  if (ownerEmail != null && ownerEmail.isNotEmpty)
                    pw.Padding(
                      ...
                      child: pw.Text(ownerEmail, style: const pw.TextStyle(fontSize: 9)),
                    ),
                ],
              ),
              pw.Container(
          ...
          pw.Container(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                if (client?.ice != null && client!.ice!.isNotEmpty)
                  pw.Text('ICE : ${client.ice}', style: const pw.TextStyle(fontSize: 9)),
                if (client?.phone != null && client!.phone!.isNotEmpty)
                  pw.Text('Tél. : ${client.phone}', style: const pw.TextStyle(fontSize: 9)),
              ],
            ),
          ),
            ...
            children: [
              ...
              ...details.items.map(
                (item) => _row([
                  ...
                  '${_number(item.unitPrice)} DH',
                  '${_number(item.taxRate)} %',
                  '${_number(item.totalTtc)} DH',
                ]),
              ),
            ],
          ),
          ...
          pw.Text(
            'Statut : ${_statusLabel(invoice.status)}',
  ...
  pw.Widget _totalRow(String label, double value, {bool bold = false}) => pw.Padding(
        ...
        child: pw.Row(
          ...
          children: [
            ...
            pw.Text('${_number(value)} DH', style: pw.TextStyle(fontSize: bold ? 11 : 9, fontWeight: bold ? pw.FontWeight.bold : pw.FontWeight.normal)),
          ],
        ),
      );
